...
// Nuevas funciones para el menú hamburguesa
...
function initHamburgerMenu() {
    ...
    const menuOptions = [
        { icon: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z', text: 'Chat' },
        { icon: 'M11 11a2 2 0 1 1 2 2 2 2 0 0 1-2-2zm-8 0a2 2 0 1 1 2 2 2 2 0 0 1-2-2zm16 0a2 2 0 1 1 2 2 2 2 0 0 1-2-2z', text: 'Chanax' },
        { icon: 'M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5', text: 'Crear Alarma' },
        { icon: 'M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9', text: 'Notificaciones' },
        { icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z', text: 'Soporte' }
    ];
    menuOptions.forEach((option, index) => {
        const button = document.createElement('button');
        button.innerHTML = `<svg class="icon" viewBox="0 0 24 24"><path d="${option.icon}"></path></svg> ${option.text}`;
        button.onclick = () => {
            showMain(index + 1);
            toggleHamburgerMenu();
        };
        hamburgerContent.appendChild(button);
    });
}
...
document.addEventListener('DOMContentLoaded', () => {
    showMain(1); // Mostrar la primera pestaña por defecto
    updateAlarmHistoryDisplay();
    initHamburgerMenu(); // Inicializar el menú hamburguesa
    adjustForMobile();
});